...
def create_database(project_path, json_path, import_size, use_allmem, skip_unique, use_dbmem):
    dd.commands.create_database(project_path, json_path, import_size, use_allmem, skip_unique, use_dbmem)
